    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                (
                    "request_id",
                    models.IntegerField(
                        default=0, primary_key=True, serialize=False, verbose_name="请求号"
                    ),
                ),
                (
                    "request_time",
                    models.DateTimeField(
                        default=django.utils.timezone.now, verbose_name="请求发出时间"
                    ),
                ),
                ...
                ("fee_rate", models.FloatField(default=0.5, verbose_name="费率")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "temp_high_limit",
                    models.IntegerField(default=0, verbose_name="最高温度限制"),
                ),
                (
                    "temp_low_limit",
                    models.IntegerField(default=0, verbose_name="最低温度限制"),
                ),
                (
                    "default_target_temp",
                    models.IntegerField(
                ...
                ("fee_rate_l", models.FloatField(default=0.3333, verbose_name="低风速费率")),
                ("fee_rate_m", models.FloatField(default=0.5, verbose_name="中风速费率")),
            ],
        ),
        migrations.CreateModel(
            name="Server",
